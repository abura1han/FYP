  ...
  render() {
    return (
      <div id="videos">
        ...
        <section className="VideoSections bg-white pt-5">
          <div className="container">
            ...
            <div id="moreVideos" className="row mx-1 py-5">
              ...
              <div id="moreBtn" className="text-center col-12 mt-4">
        ...
        <section className="VideoSections  py-5">
          <div className="container">
            <h1 className="text-center position-relative mb-5">
              Expert Reviews
            </h1>
            <div id="moreVideos" className="row mx-1 pt-5">
              <Link to="#" className="col-sm-6 col-md-4 mb-5 mb-md-5 mb-lg-0">
                <div className="thumbnailBox">
                  <div id="imgBox" className="position-relative">
                    <i className="far fa-play-circle" />
                  ...
                  <div className="thumbTitle bg-white  p-3">
                    <p className="mb-0">
                      Street Racing Car Crashes | CRASHdriven
                    </p>
                  </div>
              ...
              <Link to="#" className="col-sm-6 col-md-4 mb-5 my-lg-5">
                <div className="thumbnailBox">
                  ...
                  <div className="thumbTitle bg-white  p-3">
                    <p className="mb-0">
                      Toys Learning Name Police cars, Fire Truck Toy
                    </p>
                  </div>
                </div>
              </Link>
              <Link
                to="#"
                className="col-sm-6 col-md-4 mb-5 my-lg-5 mb-md-5 mb-lg-0"
              >
                <div className="thumbnailBox">
                  <div id="imgBox" className="position-relative">
                    <i className="far fa-play-circle" />
        ...
        <section className="VideoSections bg-white pt-5">
          <div className="container">
            <h1 className="text-center position-relative mb-5">
              PakDrive Auto Parts &amp; Accessories
            </h1>
            <div id="moreVideos" className="row mx-1 py-5">
              <Link to="#" className="col-sm-6 col-md-4 mb-5 mb-md-5 mb-lg-0 ">
                <div className="thumbnailBox">
