...
const Reports = () => {
  ...
  <li class="nav-item">
    <a class="nav-link active" id="NewCar-tab" data-toggle="tab" href="#NewCar" role="tab" aria-controls="NewCar" aria-selected="true">NewCar</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="UsedCar-tab" data-toggle="tab" href="#UsedCar" role="tab" aria-controls="UsedCar" aria-selected="false">UsedCar</a>
  </li>
...
<div className="row justify-content-center my-3"> 
      <h5 className="text-success mr-5"> <i className=" align-middle fa-solid fa-check"></i>Ignore</h5>
      <h5 className="text-danger"> <i className=" align-middle fa-solid fa-xmark"></i>Delete</h5>
    </div>

  <div class="tab-pane fade show active" id="NewCar" role="tabpanel" aria-labelledby="NewCar-tab">
  <div className="container py-5">
        <div className="row justify-content-center bg-white p-5 ">
        <div  id="carouselExampleIndicators"  className="carousel slide col-6" data-ride="carousel">
        ...
        <div className="col-4 offset-1 info">
          ...
          <span className=" stars my-3  rounded">
            ...
            <p className="price my-3">PKR 18 - 22.5 Lacs</p>
            
            <div className="features mt-4">
            <p> <i className="mr-3  car-icons fas fa-cog"></i> Manual/Automatic</p> 
            <p> <i className="mr-3  car-icons fas fa-closed-captioning"></i> 1200cc</p>
            <p><i class="mr-3 car-icons  fa-solid fa-gauge-high"></i> 18-22 K/M</p>
            <p> <i className="mr-3  car-icons fas fa-gas-pump"></i> Petrol/Gas</p>
            </div>
        </div>
        </div>
      </div>
    </div>
  <div class="tab-pane fade" id="UsedCar" role="tabpanel" aria-labelledby="UsedCar-tab">
  ...
  <div className="row pt-5">
      ...
      <div className="CarDetailCard col-6 offset-3 pb-1 ">
        ...
        <div className="numBox col-5">
          ...
          <span>03468765433</span> {/* if user is logged in, show him number */}
        </div>
      ...
      <div className="CarGeneralCard col-6 offset-3 mt-2 ">
        ...
        <div className="row">
          <div className="col-6 details position-relative mb-1">
            <p> <i className="mr-3 fa fa-calendar-alt"></i> 2019</p>
          </div>
          <div className="col-6 details position-relative mb-1">
            <p> <i className="mr-3 fa fa-road"></i> 40,000 Kms</p>
          </div>
          <div className="col-6 details position-relative mb-1">
            <p> <i className="mr-3 fa fa-user-alt"></i> First Owner</p>
          </div>
          <div className="col-6 details position-relative mb-1">
            <p> <i className="mr-3 fas fa-cog"></i> Automatic</p> 
          </div>
          <div className="col-6 details position-relative mb-1">
            <p> <i className="mr-3 fas fa-gas-pump"></i> Petrol</p>
          </div> 
          <div className="col-6 details position-relative mb-1">
            <p> <i className="mr-3 fa-solid fa-fill-drip"></i> Gray</p>
          </div>
          <div className="col-6 details position-relative mb-1">
            <p> <i className="mr-3 fas fa-closed-captioning"></i> 1200cc</p>
          </div>
          <div className="col-6 details position-relative mb-1">
            <p> <i class="mr-3 fa-solid fa-car-side"></i> SUV</p>
          </div>
          
        </div>

        <div className="mt-3 remarks">
             <h4 className="font-weight-bold">Seller's Remarks</h4> {/*if seller wants to write comment or say something  */}
